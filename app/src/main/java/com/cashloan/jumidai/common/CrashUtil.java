...
import static com.cashloan.jumidai.common.BaseParams.getSDPath;
...
public class CrashUtil implements Thread.UncaughtExceptionHandler {
    ...
    public static final String PATH = getSDPath() + "/crash/";
        ...
        try {
          ...
          //  Display display = windowManager.getDefaultDisplay();
            if (pi != null) {
                ...
                infos.put("Android Device Display", ScreenUtils.getStatusHeight(ctx) + "*" + ScreenUtils.getScreenWidth(ctx));
            }
