...
public class CreditTypeFlag {
     ...
     * 身份验证是否需要展示
     */
    public static boolean IDENTITY_FLAG = FeatureConfig.enableFeature(FeatureConfig.enableidentityFeature);
    /**
     * 公積金是否需要展示
     */
    public static boolean FUND_FLAG = FeatureConfig.enableFeature(FeatureConfig.enablefundFeature);
    /**
     * 社保是否需要展示
     */
     ...
     * 身份认证是否必填
     */
    public static boolean IDENTITY_MUST_FLAG = true;
    /**
     * 公积金是否必填
     */
    public static boolean FUND_MUST_FLAG = true;
    /**
     * 社保是否必填
     */
    public static boolean SECURITY_MUST_FLAG = true;
    /**
     * 手机运营商是否必填
     */
...
//    public static int[] CREDIT_ICON_FONT = new int[]{R.string.iconfont_person_msg,
//            R.string.iconfont_recive_bank,
//            R.string.iconfont_linker,
//            R.string.iconfont_phone_state,
////            R.string.iconfont_zhimaxinyong,
//            R.string.iconfont_identity,
//            R.string.iconfont_social_security,
//            R.string.iconfont_accumulation_fund,
//            R.string.iconfont_work_msg,
//            R.string.iconfont_zhifubao,
//            R.string.iconfont_more_msg};
}
