...
//                stateIcon = ContextHolder.getContext().getResources().getDrawable(R.drawable.icon_success);
                stateIcon = ContextHolder.getContext().getResources().getDrawable(R.drawable.shape_progress_wait);
            } else if (Constant.NUMBER_20 == type) {
//                stateIcon = ContextHolder.getContext().getResources().getDrawable(R.drawable.icon_failed);
//                stateIcon = ContextHolder.getContext().getResources().getDrawable(R.drawable.icon_failed);// todo
            } else {
//                stateIcon = ContextHolder.getContext().getResources().getDrawable(R.drawable.icon_wait);
                stateIcon = ContextHolder.getContext().getResources().getDrawable(R.drawable.shape_progress_success);
            }
        } else {
//            stateIcon = ContextHolder.getContext().getResources().getDrawable(R.drawable.icon_wait);
            stateIcon = ContextHolder.getContext().getResources().getDrawable(R.drawable.shape_progress_success);
