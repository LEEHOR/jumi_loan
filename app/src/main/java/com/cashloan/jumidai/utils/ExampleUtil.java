...
public class ExampleUtil {
    ...
    public static void showToast(final String toast, final Context mContext)
    {
    ...
    public static String getImei(Context mContext, String imei) {
        String ret = null;
        try {
    ...
    public static String getDeviceId(Context mContext) {
        return JPushInterface.getUdid(mContext);
    }
}
