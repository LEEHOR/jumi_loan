...
public class TasksCompletedView extends View {
    ...
    private void initVariable() {
        ...
        mTextPaint.setColor(getResources().getColor(R.color.white));//环中间数值文字颜色--1000
        mTextPaint.setTextSize(spToPx(25));

        mLimitPaint = new Paint();
        mLimitPaint.setAntiAlias(true);
        mLimitPaint.setStyle(Paint.Style.FILL);
        mLimitPaint.setColor(getResources().getColor(R.color.white));//环中间限制文字颜色--申请额度
