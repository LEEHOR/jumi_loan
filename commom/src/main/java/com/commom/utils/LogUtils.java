...
public class LogUtils {
    ...
    /**
     * Master switch.To catch icon_loading_nonet info you need set this value below Log.WARN
     */
     ...
     * icon_loading_nonet will always be logged at level ASSERT with the call stack.
     * Depending on system configuration, a report may be added to the
     * {@link android.os.DropBoxManager} and/or the process may be terminated
     * immediately with an icon_loading_nonet dialog.
     *
     * @param obj
     */
