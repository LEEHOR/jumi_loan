...
import com.commom.utils.encryption.DES3;
...
public class SPUtil {
     ...
     * @param datalist
     */
    public static<T> void setDataList(SharedPreferences sp,String listtag, List<T> datalist) {
     ...
     * @return
     */
    public static<T> List<T> getDataList(SharedPreferences sp,String tag) {
        List<T> datalist;
        ...
        Gson gson = new Gson();
        datalist = gson.fromJson(Json, new TypeToken<List<T>>() {
