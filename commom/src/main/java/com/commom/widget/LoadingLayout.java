...
import com.commom.R;
import com.commom.utils.ResourceUtils;
...
public class LoadingLayout extends FrameLayout {
    ...
    private static int    emptyImgId      = R.mipmap.icon_loading_empty;
    private static int    errorImgId      = R.mipmap.icon_loading_error;
    private static int    networkImgId    = R.mipmap.icon_loading_nonet;
    ...
    private static int    tipTextColor    = R.color.base_show_text_color;
    private static int    buttonTextColor = R.color.base_show_text_color;
    ...
    private static int    backgroundColor = R.color.base_background;
    ...
    private void build() {
        ...
        emptyPage.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (listener != null) {
                    listener.onReload(v);
