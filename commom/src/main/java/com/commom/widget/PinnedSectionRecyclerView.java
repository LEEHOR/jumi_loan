 ...
 * 作者： zxb
 * 时间： 2018/4/8
 * 描述： https://github.com/VK2012/PinnedSectionRecyclerView
 */
...
public class PinnedSectionRecyclerView extends RecyclerView {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mPinnedSection != null) {
            ...
            if (mShadowDrawable != null && mSectionsDistanceY > 0) {
                mShadowDrawable.setBounds(view.getLeft(), view.getBottom(),
                        view.getRight(), view.getBottom() + mShadowHeight);
    ...
    private void createPinnedSection(int position) {
        ...
        // measure & layout
        int ws = MeasureSpec.makeMeasureSpec(getWidth() - getPaddingLeft() - getPaddingRight(),
                MeasureSpec.EXACTLY);
    ...
    private boolean isPinnedViewTouched(View view, float x, float y) {
        ...
        // by taping top or bottom padding, the list performs getRxKeyEvent click getRxKeyEvent a border item.
