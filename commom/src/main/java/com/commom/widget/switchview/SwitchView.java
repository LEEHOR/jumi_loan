package com.commom.widget.switchview;
...
public class SwitchView extends View {
    ...
    private int colorOn = Color.parseColor("#ffffff");//按钮打开状态---圆圈的填充色
    private int colorOnBg = Color.parseColor("#ff00ff");//按钮打开状态---按钮背景色
    private int colorOnBorder = Color.parseColor("#000098");//按钮打开状态---圆圈的边框色
    private int colorOff = Color.parseColor("#ffffff");//按钮关闭状态---圆圈的填充色
    private int colorOffBg = Color.parseColor("#e3e3e3");//按钮关闭状态---按钮背景色
    private int colorOffBorder = Color.parseColor("#bfbfbf");//按钮关闭状态---圆圈的边框色
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(isOn ? colorOnBg : colorOffBg);
        ...
        paint.setStyle(Style.FILL);
        paint.setColor(colorOn);//圆球按钮的填充色
        canvas.drawPath(bPath, paint);

        paint.setStyle(Style.STROKE);
        paint.setStrokeWidth(bStrokeWidth * 0.5f);

        paint.setColor(isOn ? colorOnBorder : colorOffBorder);
        canvas.drawPath(bPath, paint);
