...
public class TextViewExpandableAnimation extends LinearLayout implements View.OnClickListener {
    ...
    private void initValue(Context context, AttributeSet attrs) {
        ...
        expandLines = ta.getInteger(R.styleable.TextViewExpandableAnimation_tvea_expandLines, 5);

        drawableShrink = ta.getDrawable(R.styleable.TextViewExpandableAnimation_tvea_shrinkBitmap);
        drawableExpand = ta.getDrawable(R.styleable.TextViewExpandableAnimation_tvea_expandBitmap);
        ...
        if (null == drawableShrink) {
            drawableShrink = ContextCompat.getDrawable(context, R.mipmap.icon_common_back_white);
        }

        if (null == drawableExpand) {
            drawableExpand = ContextCompat.getDrawable(context, R.mipmap.icon_common_back_white);
        }
