...
public class VerticalRunTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public VerticalRunTextView(Context context) {
        this(context, null);
        mContext = context;
    }

    public VerticalRunTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
